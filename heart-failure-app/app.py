...
# ------------------------------------------------
try:
    # Updated to match the actual file generated by your train_model.py
    model = joblib.load("modele.pkl") 
except FileNotFoundError:
    model = None
    st.error("⚠️ Warning: modele.pkl not found! Using fallback demo mode.")
...
platelets = st.sidebar.slider("Platelets", 100000.0, 500000.0, 250000.0)
...
input_df = pd.DataFrame([{
    "age": age,
    "anaemia": anaemia,
    "creatinine_phosphokinase": 250,  # placeholder
    "diabetes": diabetes,
...
The original dataset is **imbalanced (~68% survived / ~32% deceased)**.
""")
